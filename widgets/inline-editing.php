...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'byttek-masonry-grid-builder' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Title', 'byttek-masonry-grid-builder' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'byttek-masonry-grid-builder' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'byttek-masonry-grid-builder' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'byttek-masonry-grid-builder' ),
			]
		);
